      ...
      <Card className="shadow-lg rounded-lg">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-6">
            Esta área será dedicada ao acompanhamento do progresso, métricas e histórico do cliente selecionado.
          </p>
          <div className="p-10 border-2 border-dashed rounded-md flex flex-col items-center justify-center text-center bg-muted/20">
            <Icons.Activity className="h-16 w-16 text-primary/70 mb-4" />
            <p className="text-lg font-semibold text-foreground">Funcionalidade em Desenvolvimento</p>
            <p className="text-sm text-muted-foreground mt-1">
              Em breve: Gráficos de progresso, histórico de treinos, feedback e muito mais.
            </p>
          </div>
        </CardContent>
      </Card>
